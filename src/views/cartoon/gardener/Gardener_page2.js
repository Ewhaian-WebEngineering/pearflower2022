...
function garden2_animation() {
  ...
  document.getElementById("garden2_calendar").src="../../../../../img/cartoon/gardener/page2/garden2calendar3.png";
  ...
  setTimeout( () => {
    ...
    document.getElementById("garden2_calendar").src="../../../../../img/cartoon/gardener/page2/garden2calendar2.png";
  }, 1000);
  setTimeout( () => {
    ...
    document.getElementById("garden2_calendar").src="../../../../../img/cartoon/gardener/page2/garden2calendar1.png";
  }, 2000);
  setTimeout( () => {
    ...
    document.getElementById("garden2_calendar").src="../../../../../img/cartoon/gardener/page2/garden2calendar0.png";
  }, 3000);
  setTimeout( () => {
    document.getElementById("garden2_thumbup").style.visibility="visible";
    document.getElementById("garden2_thumbup").classList.add("thumbup_animation");
  }, 3500);
  setTimeout( () => {
